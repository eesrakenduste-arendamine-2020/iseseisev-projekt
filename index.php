...
<body>
    <!-- <div class="front-header grid-3-2">
        <img class="front-header-left" src="assets/images/Deskis_logo.png" alt="Logo" width="150">
        <div class="front-header-right flex-end">
            <div class="lang-switcher">
                EST ▼
                <div class="lang-sub-menu">
                    <div class="lang"><a href="/en">ENG</a></div>
                    <div class="lang"><a href="/ru">RUS</a></div>
                    <div class="lang"><a href="/lv">LV</a></div>
                </div>
            </div>
            <div class="header-button"><a href="https://www.youtube.com/watch?v=TIReTt0QHYU" target="_blank">Vaata demo</a></div>
            <div class="header-button">Proovi tasuta</div>
        </div>
        <div class="menu flex-start">
            <span class="menu-item"><a href ="/tooted/tarkvarad.php">TOOTED</a></span>
            <span class="menu-item"><a href ="/lisainfo/ettekanded.php">LISAINFO</a></span>
            <span class="menu-item"><a href ="/uudised/sundmused.php">UUDISED</a></span>
            <span class="menu-item"><a href ="/ettevote/meist.php">ETTEVÕTE</a></span>
            <div class="dropdown">
                <div class="dropdown-section">
                    <div><a href="/tooted/tarkvarad.php">Tarkvarad</a></div>
                    <div><a href="/tooted/tarkvarad.php">Tooted</a></div>
                    <div><a href="/ettevote/meist.php">Miks Deskis</a></div>
                </div>
                <div class="dropdown-section">
                    <div><a href="/lisainfo/ettekanded.php">Ettekanded</a></div>
                    <div><a href="/lisainfo/juhised.php">Juhised</a></div>
                    <div><a href="/lisainfo/oppevideod.php">Õppevideod</a></div>
                </div>
                <div class="dropdown-section">
                    <div><a href="/uudised/sundmused.php">Sündmused</a></div>
                    <div><a href="/uudised/blogi.php">Blogi</a></div>
                    <div><a href="/uudised/uudised.php">Uudised</a></div>
                </div>
                <div class="dropdown-section">
                    <div><a href="/ettevote/meist.php">Meist</a></div>
                    <div><a href="/ettevote/karjaar.php">Karjäär</a></div>
                    <div><a href="/ettevote/kontakt.php">Kontakt</a></div>
                </div>
            </div>
        </div>
        <div class="menu-icons flex-end">
            <div class="new">
                <a href="/uudised/sundmused.php">
                    <div class="svg-wrap">
                        <svg  style="width: 28px; padding-right: 32px; transform: translate(-1px, -3px);" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 60.97 68.9"><title>Deskis_events</title><g id="Layer_2" data-name="Layer 2"><g id="Layer_1-2" data-name="Layer 1"><path d="M52.52,9.34v.75a7.22,7.22,0,0,1-14.44,0V9.34H22.89v.75a7.22,7.22,0,0,1-14.44,0V9.34H0V68.9H61V9.34ZM54.58,61.9H6.39V23.68H54.58Z"/><path d="M15.67,0a5.1,5.1,0,0,0-5.1,5.1v5a5.1,5.1,0,1,0,10.19,0v-5A5.09,5.09,0,0,0,15.67,0Z"/><path d="M45.3,0a5.09,5.09,0,0,0-5.09,5.1v5a5.1,5.1,0,1,0,10.19,0v-5A5.1,5.1,0,0,0,45.3,0Z"/><rect x="10.45" y="38.97" width="7.17" height="7.17"/><rect x="10.49" y="49.81" width="7.17" height="7.17"/><rect x="21.43" y="49.81" width="7.17" height="7.17"/><rect x="32.38" y="49.81" width="7.17" height="7.17"/><rect x="10.36" y="28.12" width="7.17" height="7.17"/><rect x="21.31" y="38.96" width="7.17" height="7.17"/><rect x="32.26" y="38.96" width="7.17" height="7.17"/><rect x="43.2" y="38.96" width="7.17" height="7.17"/><rect x="21.21" y="28.11" width="7.17" height="7.17"/><rect x="32.16" y="28.11" width="7.17" height="7.17"/><rect x="43.11" y="28.11" width="7.17" height="7.17"/></g></g></svg>
                    </div>
                </a>
            </div>
            <div class="new">
    ...
    <div class="grid-3-2" style="margin-top: 30px;">
        <div class="front-header-image">
            <div class="front-header-image-text">
                ...
                <p>Seome tegevused ühtseks vooks</p>
            </div>
        </div>
        <div class="front-slider">
            <img name="slider" alt="Slider">
            <!-- <div class="slider-text">
                <div class="slider-button">OTSI</div>
                <div class="slider-button">KONTAKT</div>
            </div> -->
        ...
        <div class="front-icons grid-3" id="front-icons">
            <div class="front-product-shortcut">
                <h3>LEPING 1</h3>
        ...
        <div class="front-header-sub-text">
            ...
            <!-- <div class="social-icons grid-1">
                <div class="flex-center">
                    <a href="https://facebook.com" target="_blank"><img src="assets/images/facebook.svg" width="25" alt="Facebook"></a>
                </div>
                <div class="flex-center">
                <a href="https://instagram.com" target="_blank"><img src="assets/images/instagram.svg" width="25" alt="Instagram"></a>
                </div>
                <div class="flex-center">
                    <a href="https://youtube.com" target="_blank"><img src="assets/images/youtube.svg" width="25" alt="Youtube"></a>
                </div>
                <div class="flex-center">
                    <a href="https://medium.com" target="_blank"><img src="assets/images/medium.svg" width="25" alt="Medium"></a>
                </div>
            </div> -->
        </div>
    </div>
