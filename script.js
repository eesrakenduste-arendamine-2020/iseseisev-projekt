...
function SetupCanvas(){
    ...
    tetrisLogo = new Image(340, 236);
    tetrisLogo.onload = DrawTetrisLogo;
    tetrisLogo.src = "tetrislogo.png";

    ctx.fillStyle = 'black';
    ctx.font = '21px Arial';
    ctx.fillText("SKOOR", 300, 98);
    ctx.strokeRect(300, 107, 161, 24);
    ctx.fillText(score.toString(), 310, 127);
    ctx.fillText("TASE", 300, 157);
    ctx.strokeRect(300, 171, 161, 24);
    ctx.fillText(level.toString(), 310, 190);
    ctx.fillText("MÄNGUSEIS", 300, 221);
    ctx.fillText(winOrLose, 310, 261);
    ctx.strokeRect(300, 232, 161, 95);
    ctx.fillText("JUHTIMINE", 300, 354);
    ctx.strokeRect(300, 366, 161, 104);
    ctx.font = '19px Arial';
    ctx.fillText("← : Vasakule", 310, 388);
    ctx.fillText("→ : Paremale", 310, 413);
    ctx.fillText("↓ : Alla", 310, 438);
    ctx.fillText("R : Ümberpöörd", 310, 463);
