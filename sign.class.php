...
class signDoc {
                ...
                <ol start="3">
                    <li><strong>TEENUSE HIND JA TASUMINE</strong>
                        <ol>
                            ...
                            <li>Teenuse kasutamise eest tasumine toimub poolt esitatud arve alusel, mille makset&auml;htaeg on v&auml;hemalt 

                            <select name="days" id="input8" data-id="8" class="input"'; if($this->daysError == "Palun valige.") {
                                    echo 'style="background-color: #ff5f5f;"';
                                } echo ' >
                                <option disabled selected>Vali</option>
                                <option value="7"'; if($this->days == "7") {echo 'selected';} echo '>7</option>
                                <option value="14"'; if($this->days == "14") {echo 'selected';} echo '>14</option>
                            </select>

                            t&ouml;&ouml;p&auml;eva.<span class="span-error" id="8">'. $this->daysError. '</span></li> 
    ...
    public function checkInput($data) {
        ...
        if(isset($data['days']) && !empty($data['days'])) {
            $this->days =  $this->testInput($data['days']);
            $this->daysError = null;
        } else {
            $this->daysError = "Palun valige.";
            $this->error = true;
        }   
