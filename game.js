...
function difficultyValue(e) {
  if (
    ...
    if (e.target.value != undefined) {
      ...
      userDifficultyNotification =
        "Your current difficulty is " + userDifficulty;

      if (userDifficulty == "Easy") {
        difficultyEasy();
        showScore();
        console.log(
          "Difficulty is easy and pointreduction is -" + pointReduction
        );
      } else if (userDifficulty == "Normal") {
        difficultyNormal();
        showScore();
        console.log(
          "Difficulty is normal and pointreduction is -" + pointReduction
        );
      } else if (userDifficulty == "Hard") {
        difficultyHard();
        showScore();
        console.log(
          "Difficulty is hard and pointreduction is -" + pointReduction
        );
      }
...
function nextRound() {
  $("#wordsSpot").html(
    "Are you ready for the next one? Words will appear here"
  );
}
function lostRound() {
...
function showUserScore() {
  ...
  if (currentMode == "Hard" && hardWon == "Lost") {
    regRecentScore =
      "Sadly you made three mistakes in hard mode, but congratulations " +
      currentPlayer +
      " your score in difficulty " +
      currentMode +
      " was " +
      recentInfo +
      bonusNotification;
    ...
    regRecentScore =
      "Dude why would you quit? Anyways " +
      currentPlayer +
      " your score in difficulty " +
      currentMode +
      " was " +
